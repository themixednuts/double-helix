...
pub fn default() -> HashMap<Mode, KeyTrie> {
    let normal = keymap!({ "Normal mode"
        ...
        "space" => { "Space"
            ...
            "e" => file_explorer,
            // `space .` is upstream's binding; `space E` stays for existing muscle memory.
            ...
            "A" => { "Assistant"
                ...
                "o" => ":assistant-open",
                "x" => ":assistant-cancel",
                "h" => ":assistant-open-history",
                "i" => assistant_focus_input,
                "m" => assistant_focus_entries,
                "d" => assistant_open_entry_scratch,
                "q" => assistant_close_panel,
                "t" => assistant_toggle_follow,
                "C-t" => assistant_cycle_thinking,
                "C-m" => assistant_cycle_model,
                "S-tab" => assistant_cycle_mode,
            },
            "'" => last_picker,
