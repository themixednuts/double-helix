...
pub use config::{
    ...
    KittyKeyboardProtocolConfig, LineEndingConfig, LineNumber, LspConfig, ModeConfig,
    NotificationBorderConfig, NotificationBorderStyle, NotificationConfig, NotificationEmojis,
    NotificationIcons, NotificationPosition, NotificationShadowConfig, NotificationStyle,
    PickerStartPosition, PopupBorderConfig, SearchConfig, SignatureHelpPosition, SmartTabConfig,
