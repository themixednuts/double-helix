...
use fff_search::{
    FilePickerOptions, FilePickerScanOptions, FuzzySearchOptions, PaginationArgs, QueryParser,
};
...
fn create_picker(base: &Path, specs: &[&str]) -> FilePicker {
    ...
    let mut picker = FilePicker::new(FilePickerOptions {
        ...
        watch: false,
        // FFF_SCAN_OPTIONS_BLOCKER: the vendored scan default hides dot entries
        // everywhere; opt into upstream's in-git-repo behavior explicitly.
